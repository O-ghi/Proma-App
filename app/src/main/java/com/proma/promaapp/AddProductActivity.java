        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (productId.isEmpty() || productName.isEmpty() || etPrice.getText().toString().isEmpty() || etQuantity.getText().toString().isEmpty()) {
                    Toast.makeText(AddProductActivity.this, "Hãy điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                } else if (imageUri == null) {
                    Toast.makeText(AddProductActivity.this, "Hãy chọn hình ảnh cho sản phẩm", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSION_CAMERA) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Chưa được cấp quyền lưu trữ", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void saveProduct(String productId, String productName, double price, int quantity, String storeId, String expiryDate) {
        ...
        imageRef.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddProductActivity.this, "Có lỗi xảy ra, không lưu được hình ảnh", Toast.LENGTH_SHORT).show();
                    }
                });
    }
